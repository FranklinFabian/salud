<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">Gestión de Custodios</h3>
        </div>
        <div class="card-toolbar">
            ...
            <span class="svg-icon svg-icon-lg">
                ...
                Nuevo Registro {{ $data['pid']}}</a>
        </div>
    </div>
    <div class="card-body">
        <table class="table table-bordered table-hover table-checkable" id="module_datatable" style="margin-top: 13px !important">
            <thead>
...
<script src="{{ asset('scripts/parqueinformatico/item/lista/index.js') }}" type="text/javascript"></script>
