...
<div class="navi navi-spacer-x-0 pt-5">
    ...
    <div class="navi-footer  px-8 py-5">
        <a class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" href="{{ route('autenticacion.logout') }}"
           onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
            {{ __('Cerrar Sesión') }}
        </a>
        <form id="logout-form" action="{{ route('autenticacion.logout') }}" method="POST" style="display: none;">
            @csrf
        </form>
        <!-- <a href="#" target="_blank" class="btn btn-light-primary font-weight-bold">Cerrar Sesión</a>-->
