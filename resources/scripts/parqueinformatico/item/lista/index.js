...
window.loadWindow = function(id, type) {
    $.get(HOST_URL + '/parqueinformatico/item/lista/' + id + '/' + type + '/edit', function (data) {
...
function itemDeleteAction(id){
    $.ajax({
        url : HOST_URL + '/parqueinformatico/item/lista/' + id,
        type: 'DELETE'
...
var KTDatatablesDataSourceAjaxServer = function() {
    var initTable1 = function() {
        window.table = $('#module_datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: HOST_URL + '/parqueinformatico/item/lista/datatable/' + 1 + '/' + 1 ,
                type: 'GET'
                /*data: {
            ...
            columns: [
                ...
                { data: 'marca', name: 'picma.marca', title: 'Marca' },
                { data: 'modelo', name: 'picmo.estado', title: 'Modelo' },
